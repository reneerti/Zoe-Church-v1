...
export default function Biblia() {
  ...
  // Buscar usuário autenticado via Supabase
  useEffect(() => {
    const getUser = async () => {
      const {
        data: { user },
  ...
  console.log("Books:", books, "Loading:", loadingBooks, "Error:", booksError);
  ...
  return (
    <>
      ...
      <PageContainer>
        ...
        {/* Error State */}
        {(booksError || versionsError) && (
          <div className="py-6 text-center">
            <p className="text-destructive">Erro ao carregar dados da Bíblia.</p>
            <p className="text-sm text-muted-foreground mt-2">Verifique a conexão com o banco de dados.</p>
          </div>
        )}

        {!loadingBooks && !loadingVersions && !booksError && !versionsError && (
          <>
            {!selectedTestament ? (
              // Testament Selection
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {totalChaptersRead} / {totalChapters || 1189}
                      </span>
                    </div>
                ...
                {filteredBooks.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                      Verifique se a tabela bible_books possui dados.
                    </p>
                  </div>
                ) : (
